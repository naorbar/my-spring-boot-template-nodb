 ...
 * 	</li>
 *  <li>SSL Support:<BR>
 *  	To enable the SSL support for the embedded tomcat application server, generate a keystore file and set these properties in application.properties file: <BR>
 ...
 * 		To enable the OOBT tomcat security, add the following dependency to the pom (to disable the security remove this dependency):</p>
 * 		<pre>
 * 		&ltdependency>
...
public class StartAppServer {
	...
	public static void main(String[] args) throws Exception {
		// This line is used to load the 'prod' profile, i.e. the "application-prod.properties" which is used to enable the SSL support for the embedded tomcat application server
