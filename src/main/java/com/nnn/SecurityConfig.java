...
/**
 * <p>This class is used to configure basic authentication for the embedded Tomcat application server</p>
 * <p>To enable the OOBT tomcat security we can add the following dependency to the pom (to disable the security remove this dependency):</p>
 * <pre>
 * 	&ltdependency>
